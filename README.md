...
3. **Polarity Assignment**:
   - Score ≥ 5: "virtue" (positive expression of the foundation)
   - Score < 5: "vice" (negative expression of the foundation)
...
- **moralstrength Library**: [GitHub Repository](https://github.com/oskargargas/moralstrength)
